...
Aos 18 anos, tive meu primeiro contato com Python e progamação de forma mais aprofundada por meio do conteúdo oferecido <a href="https://panda.ime.usp.br/panda/static/pensepy/index.html">ime</a>. explorando o vasto universo dessa linguagem dinâmica e versátil. Agora, estou imerso em um emocionante projeto de desenvolvimento mobile voltado para uma cidade de pequeno porte. Concentro-me no aprendizado e aplicação prática do framework Flutter, consolidando meu conhecimento e habilidades para criar soluções inovadoras e impactantes.
